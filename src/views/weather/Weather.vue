...
<template>
    <right-menu @rightclick="rightClick" border-radius="25px" data-tauri-drag-region>
        <div style="display:flex;">
            <img class="rightmenu-img" :src="'icon/poi.png'" @click="show = !show" draggable="false" />
            <img class="rightmenu-img" :src="'icon/transparent.png'" @click="transparentbool = !transparentbool" draggable="false" />
            <img class="rightmenu-img" :src="'icon/changecolor.png'" @click="colorChange" draggable="false" />
            <img class="rightmenu-img" :src="top?'icon/wintop.png':'icon/windown.png'" @click="settop" draggable="false" />
            <img class="rightmenu-img" :src="'./icon/close.png'" @click="appWindow.close()" draggable="false" />
        </div>
    </right-menu>
    <!-- 城市选择 -->
